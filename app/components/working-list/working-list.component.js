...
var WorkingList = (function () {
    function WorkingList(pagerService, transservice, userService) {
    ...
    WorkingList.prototype.ngOnInit = function () {
        var _this = this;
        this.id = JSON.parse(localStorage.getItem('currentProfile')).id;
        this.transservice.getTranslatesByTranslator(this.id).subscribe(function (data) {
            _this.translist = data;
            console.log(_this.translist);
            _this.setPage(1);
        });
    };
    WorkingList.prototype.setPage = function (page) {
...
exports.WorkingList = WorkingList;
